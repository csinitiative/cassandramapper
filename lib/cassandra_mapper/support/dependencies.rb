...
require 'cassandra_mapper/core_ext/module/introspection'
require 'cassandra_mapper/core_ext/module/anonymous'
require 'cassandra_mapper/core_ext/object/blank'
require 'cassandra_mapper/core_ext/load_error'
require 'cassandra_mapper/core_ext/name_error'
require 'cassandra_mapper/core_ext/string/starts_ends_with'
...
CassandraMapper::Support::Dependencies.hook!